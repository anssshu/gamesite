...
app.config(["$routeProvider",
			function($routeProvider){
				$routeProvider
				.when("/login",{
						templateUrl:'apps/ng-login/html/login.html',
						controller:'LoginController'
					})
				.when("/signup",{
						templateUrl:'apps/ng-login/html/signup.html',
						controller:'SignupController'
					})
                .when("/forgotPassword",{
						templateUrl:'apps/ng-login/html/forgotPassword.html',
						controller:'ForgotPasswordController'
					})

				.otherwise({
						templateUrl:'apps/ng-login/html/home.html',
...
app.controller("LoginController",function($scope,$http,$window){
    ...
    //when login button is clicked
        ...
        .then(function(res){
            ...
            if (res.data=="success")$window.location.href='/success#/?page=newgames';
